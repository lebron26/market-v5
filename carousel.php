  ...
  <body>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div data-p="170.00">
                <img data-u="image" src="images/banners/Boardroom.jpg" />
                ...
                <div class="middle"  style="color: white;position:absolute;top:300px;right:420px;width:150px;height:40px;background-color:transparent; border: 1px solid white; font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;">
                  <div class="text">Learn More
                      </div>
                </div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="images/banners/vd_pdp_feature00.png"/>
                <div data-u="caption" data-t="0" style="position:absolute;top:320px;left:30px;width:500px;height:40px;background-color:rgba(255,188,5,0.8);font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;">TSA Group Marketplace</div>


            </div>
            <div data-p="170.00">
                <img data-u="image" src="images/banners/maxresdefault.jpg" />
                <div data-u="caption" data-t="0" style="position:absolute;top:320px;left:30px;width:500px;height:40px;background-color:rgba(255,188,5,0.8);font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;">TSA Group Marketplace</div>
            </div>
            <div data-p="170.00">
                <img data-u="image" src="images/banners/ecommerce.jpg" />
                <div data-u="caption" data-t="0" style="position:absolute;top:320px;left:30px;width:500px;height:40px;background-color:rgba(255,188,5,0.8);font-family:Oswald,sans-serif;font-size:32px;font-weight:200;line-height:1.2;text-align:center;">TSA Group Marketplace</div>
            </div>
